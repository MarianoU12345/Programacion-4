...
Vue.component('materia-component', require('./components/MateriasComponent.vue').default);
Vue.component('inscripcion-component', require('./components/InscripcionesComponent.vue').default);
    ...
    methods:{
        ...
        abrirBd(){
            ...
            indexDb.onupgradeneeded = e=>{
                ...
                tblmatricula = db.createObjectStore('inscripcion', {keyPath:'idInscripcion'});
                ...
                tblmatricula.createIndex('idInscripcion', 'idInscripcion', {unique:true});
